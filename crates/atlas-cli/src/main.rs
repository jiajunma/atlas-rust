...
// The interpreter's hot paths are allocation-dominated (perf job 3680340:
// ~24% of samples inside glibc malloc/free/realloc on the E6 workload), so
// route every Rust allocation through mimalloc instead of the glibc arena.
#[global_allocator]
