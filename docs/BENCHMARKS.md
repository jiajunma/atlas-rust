...
| 3624257 | 32097c1 (contains b456e1c) | 240 | 5 | FULL CORPUS GREEN with mod-space transport + simple-reflection permutation cache (MATCH 238/238 + 2 SKIPPED_LARGE): median rust/cpp 4.01x -> 3.30x, over_5x 23 -> 5 (worst groups.at/test.at 5.6x), within_2x 50 -> 51, rust_faster 4. unipotent 22.3s -> 14.64s (3.81x -> 2.40x vs cpp 6.11s; rust_maxrss 3.64GB vs cpp 860MB). NOTE: job submitted at b456e1c but `git rev-parse HEAD` at job start recorded 32097c1 (another agent's simple-reflection permutation cache landed in between) — row measures the union |
