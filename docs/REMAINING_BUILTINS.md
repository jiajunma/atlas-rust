...
| 8 | misc: Cartan_info, KGB_Hasse, block_Hasse, orientation_nr, shift_flip | PARTIAL: KGB_Hasse DONE (`domain/kgb_hasse`, HPC `3506900`). Cartan_info needs the simpleImaginary/Real/Complex subsystem classification and fiber/orbit sizes on CartanClass (classify_involution + WeylWord are already available); block_Hasse and orientation_nr need the Param layer. |
