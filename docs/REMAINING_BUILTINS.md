...
| 7 | deform variants: twisted_deform, twisted_full_deform, block_deform, full_deform, KL_block | PARTIAL: **full_deform** lands (`7a5c2a3`) — finals_for (repr.cpp:1205-1297) + reducibility_points (repr.cpp:825-925) + scale/deform_readjust/deformation_terms, as a KTypePol; A1/A2/B2/G2/A3 byte-identical (fixture `domain/full_deform`, HPC `3511044` submitted). block_deform needs block_deformation_to_height; the twisted variants and KL_block need ext_block/common_block. |
