...
FIXTURE_PLANS = (
    ...
    # deform in no-value (statement) position: upstream's gate comes first
    # (atlas-types.w:8085-8087), so the call is silently dropped.
    FixturePlan(name="domain/deform_no_value"),
