...
class PipelineSwapDiffTest(unittest.TestCase):
    ...
    def test_kl_column_is_fully_runnable_after_proper_subsystem_port(self) -> None:
        ...
        self.assertEqual(runnable_lines, tuple(range(1, 165)))
        self.assertEqual(runnable_events, tuple(range(len(events))))
        self.assertEqual(errors, [])
